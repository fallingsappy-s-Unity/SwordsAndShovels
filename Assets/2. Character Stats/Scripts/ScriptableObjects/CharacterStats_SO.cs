...
public class CharacterStats_SO : ScriptableObject
{
    ...
    public void EquipWeapon(ItemPickUp weaponPickUp, CharacterInventory charInventory, GameObject weaponSlot)
    {
        ...
        //newWeapon = Instantiate(weaponPickUp.itemDefinition.weaponSlotObject, weapon.transform);
        //currentDamage = baseDamage + weapon.itemDefinition.itemAmount;
    }

    public void EquipArmor(ItemPickUp armorPickUp, CharacterInventory charInventory, GameObject weaponSlot)
    {
